...
$query = "SELECT kode, nama_matkul, sks, semester, Matkul.id_dosen ,nama_dosen FROM matkul LEFT JOIN Dosen USING(id_dosen) WHERE kode = '$kode'";
...
<tr>
    ...
    <td>:</td>
    <td><input type="nusmber" name="sks" id="sks" value="<?php echo $data_dosen['sks']; ?>"></td>
</tr>
<tr>
